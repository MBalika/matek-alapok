      ...
      >
        ...
        >
          ...
          <Lepes cim="(b) 3. lépés — a merőleges összetevő és az ellenőrzés">
            ...
            <MB>{"\\mathbf{u}_{\\perp}\\cdot\\mathbf{v} = \\frac{19}{7}\\cdot(-2) + \\frac{13}{14}\\cdot 3 + \\frac{37}{14}\\cdot 1 = -\\frac{76}{14} + \\frac{39}{14} + \\frac{37}{14} = 0 \\ ✓"}</MB>
          </Lepes>
        </KidolgozottFeladat>
        ...
        >
          ...
          <Lepes cim="(a) 3. lépés — ellenőrzés merőlegességgel">
            <MB>{"(-7)\\cdot 3 + 13\\cdot(-1) + 17\\cdot 2 = -21-13+34 = 0 \\ ✓"}</MB>
            <MB>{"(-7)\\cdot 5 + 13\\cdot 4 + 17\\cdot(-1) = -35+52-17 = 0 \\ ✓"}</MB>
          </Lepes>
        ...
        >
          ...
          <Lepes cim="(b) 2. megoldás — a behelyettesítéses képlettel (a „rövid út”)">
            <KepletDoboz
              ...
              eredmeny={"d = \\frac{3\\sqrt{14}}{7} \\approx 1{,}604 \\ ✓"}
            />
            <p>
